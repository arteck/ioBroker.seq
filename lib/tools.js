 ...
 * @returns {it is Record<string, any>} `true` if the variable is a real object, otherwise `false`
 */
 ...
 *
 * @param {any} it The variable to test
 * @returns {it is any[]} `true` if the variable is an Array, otherwise `false`
 */
function isArray(it) {
